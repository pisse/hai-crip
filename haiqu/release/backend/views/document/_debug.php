...
<script src="<?php echo $this->baseUrl; ?>/js/jsbeautify.js" type="text/javascript"></script>
<script src="<?php echo $this->baseUrl; ?>/js/common.js" type="text/javascript"></script>
...
$(function(){
	$('#submit-btn').click(function(){
		...
		console.log('<?php echo $debugUrl; ?>');
		console.log('<?php echo $model->method; ?>');
		$.ajax({
