...
$this->showsubmenu('附件管理', array(
	array('列表', Url::toRoute('hfd-attachment/list'), 1),
	array('添加附件', Url::toRoute('hfd-attachment/add'), 0),
));
...
<table class="tb tb2 fixpadding">
	...
	<tr>
		<td><a href="<?php echo Url::to(['hfd-attachment/list', 'prefix' => strval($v['prefix'])]); ?>"><?php echo basename($v['prefix']).'/'; ?></a></td>
		<td>文件夹</td>
		<td>-</td>
		<td>-</td>
		<td>-</td>
	...
	<tr>
		...
		<td><a onclick="return confirmMsg('确定要删除吗？不可恢复哦！');" href="<?php echo Url::to(['hfd-attachment/delete', 'key' => strval($content['address'])]); ?>">删除</a></td>
	</tr>
	<?php endforeach; ?>
</table>